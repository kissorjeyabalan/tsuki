...
import no.kij.tsuki.data.preferences.session.repository.SessionRepositoryImpl
import no.kij.tsuki.data.preferences.session.source.SessionLocalSource
import no.kij.tsuki.data.preferences.session.source.SessionLocalSourceImpl
import no.kij.tsuki.domain.session.repository.SessionRepository

@Module
@InstallIn(SingletonComponent::class)
internal sealed interface SessionBindingModule {
    @Binds
